...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_build_sparse_csc_double|: build sparse matrix using CSC with \verb|double| entries}
...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_build_sparse_csc_int|: build sparse matrix using CSC with \verb|int32_t| entries}
...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_build_sparse_csc_mpq|: build sparse matrix using CSC with \verb|mpq_t| entries}
...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_build_sparse_csc_mpfr|: build sparse matrix using CSC with \verb|mpfr_t| entries}
...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_build_sparse_csc_mpz|: build sparse matrix using CSC with \verb|mpz_t| entries}
...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_build_sparse_trip_double|: build sparse matrix using triplet with \verb|double| entries}
...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_build_sparse_trip_int|: build sparse matrix using triplet with \verb|int32_t| entries}
...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_build_sparse_trip_mpq|: build sparse matrix using triplet with \verb|mpq_t| entries}
...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_build_sparse_trip_mpfr|: build sparse matrix using triplet with \verb|mpfr_t| entries}
...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_build_sparse_trip_mpz|: build sparse matrix using triplet with \verb|mpz_t| entries}
...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_build_dense_double|: build \verb'SLIP_dense' matrix from a 2D \verb|double| array}
...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_build_dense_int|: build \verb'SLIP_dense' matrix from a 2D \verb|int32_t| array}
...
\verb|SLIP_build_dense_int| builds a \verb'SLIP_dense' matrix \verb'C'
from a 2D \verb|int32_t| array \verb'B'.

%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_build_dense_mpq|: build \verb'SLIP_dense' matrix from a 2D \verb|mpq_t| array}
...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_build_dense_mpfr|: build \verb'SLIP_dense' matrix from a 2D \verb|mpfr_t| array}
...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_build_dense_mpz|: build \verb'SLIP_dense' matrix from a 2D \verb|mpz_t| array}
...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_create_int_mat|: create a $m$-by-$n$ \verb|int32_t| matrix}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_delete_int_mat|: delete a $m$-by-$n$ \verb|int32_t| matrix}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_create_mpfr_array|: create a \verb|mpfr_t| of length $n$}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_delete_mpfr_array|: delete a \verb|mpfr_t| of length $n$}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_create_mpq_array|: create a \verb|mpq_t| of length $n$}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_delete_mpq_array|: delete a \verb|mpq_t| of length $n$}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_create_mpz_array|: create a \verb|mpz_t| of length $n$}
...
%-------------------------------------------------------------------------------
\cprotect\subsection{\verb|SLIP_delete_mpz_array|: delete a \verb|mpz_t| of length $n$}
%-------------------------------------------------------------------------------
