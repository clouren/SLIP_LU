...
// Timothy A. Davis, Teyas A&M University  All Rights Reserved.  See
        ...
        case SLIP_MPQ:
        {
            ...
            switch (xtype)
            {
                ...
                case SLIP_MPFR: // mpfr_t to mpq_t
                {
                    ...
                    for (int64_t k = 0 ; k < n ; k++)
                    {
                        SLIP_mpfr_get_q( y[k], x[k], option2->round);
                    }
                }
                break ;
        ...
        case SLIP_MPFR:
        {
            ...
            switch (xtype)
            {
                ...
                case SLIP_INT64: // int64 to mpfr_t
                {
                    ...
                    for (int64_t k = 0 ; k < n ; k++)
                    {
                        SLIP_mpfr_set_si(y[k], x[k], option2->round);
                    }
                }
                break ;
        ...
        case SLIP_INT64:
        {
            ...
            switch (xtype)
            {
                ...
                case SLIP_MPFR: // mpfr_t to int64_t
                {
                    ...
                    for (int64_t k = 0 ; k < n ; k++)
                    {
                        SLIP_CHECK( SLIP_mpfr_get_si( &(y[k]), 
                                                      x[k], option2->round));
                    }
                }
                break ;
